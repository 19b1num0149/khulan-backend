...
<template>
    ...
    <div>
        <Head :title="$t('settingsRegionAdd')" />
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <page-title 
                :title="$t('settingsRegion')"
                :subtitle="$t('settingsRegionAdd')"></page-title>
            ...
            <div class="max-w-[600px] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $t('settingsRegionAdd') }}</h5>
                <hr class="mt-4 mb-4">                
                <form @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        <Link class="py-2.5 px-5 ml-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" 
                              href="/settings/region">{{ $t('back') }}</Link>
                    </div>
                </form>
