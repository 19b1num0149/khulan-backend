<script setup>
    ...
    const form = useForm({
        ...
        category: props.vacancy.hr_category_id,
        type: props.vacancy.hr_type_id,
        jobtype: props.vacancy.hr_jobtype_id,
        duration: props.vacancy.duration,
        country: props.vacancy.country_id,
        region: props.vacancy.region_id,
        city: props.vacancy.city_id,
        salary: props.vacancy.salary == 'n/a' ? '' : props.vacancy.salary.replace(/\,/g,''),
        customer: props.vacancy.hr_customer_id == null ? '' : props.vacancy.hr_customer_id,     
        _prev: props.prev
    })

    function submit() {
        form.put(`/company/hr/vacancy/${props.vacancy.id}`, {
            preserveScroll: true
        })
    }
...
<template>
    ...
    <div>
        <Head>
            <title>{{ $t('hrVacancyEdit') }}</title>
        </Head>
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <page-title 
                :title="$t('hrVacancy')"
                :subtitle="$t('hrVacancyEdit')"></page-title>

            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">                
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $t('hrVacancyEdit') }}</h5>
                <hr class="mt-4 mb-4">
