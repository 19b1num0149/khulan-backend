<template>
    <div class="bg-white shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 border-t border-gray-200 fixed left-0 right-0 bottom-0 z-50">
